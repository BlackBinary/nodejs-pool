...
2. Run the [deploy script](https://raw.githubusercontent.com/BlackBinary/nodejs-pool/master/deployment/deploy.bash) as a **NON-ROOT USER**.  This is very important!  This script will install the pool to whatever user it's running under!  Also.  Go get a coffee, this sucker bootstraps the electroneum installation.
...
Install Script:
```bash
curl -L https://raw.githubusercontent.com/BlackBinary/nodejs-pool/master/deployment/deploy.bash | bash
```
...
You should take a look at the [wiki](https://github.com/BlackBinary/nodejs-pool/wiki/Configuration-Details) for specific configuration settings in the system.
