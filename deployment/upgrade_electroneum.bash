#!/bin/bash
echo "This assumes that you have a standard nodejs-pool install, and will patch and update it to the latest stable builds of Electroneum."
sleep 15
...
curl -L https://raw.githubusercontent.com/BlackBinary/nodejs-pool/master/deployment/electroneum_daemon.patch | sudo git apply -v
sudo rm -rf build
sudo make -j$(nproc)
