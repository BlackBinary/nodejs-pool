...
cd ~
git clone https://github.com/BlackBinary/nodejs-pool.git  # Change this depending on how the deployment goes.
cd /usr/src/gtest
sudo cmake .
sudo make
...
curl https://raw.githubusercontent.com/BlackBinary/nodejs-pool/master/deployment/electroneum_daemon.patch | sudo git apply -v
sudo make -j$(nproc)
